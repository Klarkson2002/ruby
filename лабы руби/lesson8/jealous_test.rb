...
questions = [
    ...
    "Вы распрашиваете его о работе, о коллегах?",
    ...
    "Вы всегда спрашиваете у него, куда он ходит и с кем встерчается?",
    "Если вы на него обижены, то молчите по несколько дней?",
...
results = [
    ...
    "Вы болезненно ревнивы. Не думайте, что если избраник вас любит, " +
    "то он автомотически становится вашей собственностью. Вы считаете себя непривлекательной" +
    ...
    # 5-9 ответов "да"
    "Ваша ревность действует на вас мобилизующе, но не она одна управляет вашим попедением. " +
    ...
    # Менее 5 ответов "да"
    "Вам совершенно незаконо чувствовать ревность. Но тревога и беспокойство могут накапливаться " +
